...
<html>
<head>
<title>Time Planning and Management System</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="School, Timetable, Students" />
<script type="application/x-javascript"> addEventListener("load", function() { setTimeout(hideURLbar, 0); }, false); function hideURLbar(){ window.scrollTo(0,1); } </script>

<!-- Bootstrap Core CSS -->
<link href="<?php echo base_url(); ?>assets/dashboard/css/bootstrap.css" rel='stylesheet' type='text/css' />
...
<!-- side nav css file -->
<link href='<?php echo base_url(); ?>assets/dashboard/css/SidebarNav.min.css' media='all' rel='stylesheet' type='text/css'/>
<!-- //side nav css file -->
...
<script src="<?php echo base_url(); ?>assets/dashboard/js/pie-chart.js" type="text/javascript"></script>
...
<!-- //pie-chart --><!-- index page sales reviews visitors pie chart -->
    ...
    <!-- requried-jsfiles-for owl -->
                    <link href="<?php echo base_url(); ?>assets/dashboard/css/owl.carousel.css" rel="stylesheet">
                    <script src="<?php echo base_url(); ?>assets/dashboard/js/owl.carousel.js"></script>
                        <script>
                            $(document).ready(function() {
