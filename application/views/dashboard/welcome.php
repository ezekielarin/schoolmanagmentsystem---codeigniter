	...
	<!-- for amcharts js -->
			<script src="<?php echo base_url(); ?>assets/dashboard/js/amcharts.js"></script>
			<script src="<?php echo base_url(); ?>assets/dashboard/js/serial.js"></script>
			<script src="<?php echo base_url(); ?>assets/dashboard/js/export.min.js"></script>
			<link rel="stylesheet" href="<?php echo base_url(); ?>assets/dashboard/css/export.css" type="text/css" media="all" />
			<script src="<?php echo base_url(); ?>assets/dashboard/js/light.js"></script>
	<!-- for amcharts js -->

    <script  src="<?php echo base_url(); ?>assets/dashboard/js/index1.js"></script>
    ...
    <script src="<?php echo base_url(); ?>assets/dashboard/js/utils.js"></script>
	...
	<!-- side nav js -->
	<script src='<?php echo base_url(); ?>assets/dashboard/js/SidebarNav.min.js' type='text/javascript'></script>
	<script>
	...
	<script src="<?php echo base_url(); ?>assets/dashboard/js/SimpleChart.js"></script>
    <script>
        var graphdata1 = {
            linecolor: "#CCA300",
            title: "Monday",
