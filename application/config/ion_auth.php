...
$config['join']['institution_users'] = 'user_id';
 ...
 */
$config['site_title']                 = "School Ms - Glass Cup Enterprise";       // Site Title, example.com
$config['admin_email']                = "admin@glasscup.com.ng"; // Admin Email, admin@example.com
